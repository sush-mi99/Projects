form3.addEventListener('submit', function (e) {
    ...
    if (
        ...
        let url = "http://localhost:8080/Salvatore_Bank1/deposit";
        fetch(url, {
            method: 'post',
            body: JSON.stringify({
            ...
            .then(function (response) {
                ...
                results.innerHTML = `<p>You have Successfully Deposited</p><br>
                					 <p><a href='/Salvatore_Bank1/deposits'>Click Here to View Your Transaction Details</a></p><br>
                					 <p><a href='/Salvatore_Bank1/CustomerMenu.html'>Click Here to go to Menu</a></p><br>`
               })
    } else {
        console.log("errors");
        var results = document.getElementById('results')
